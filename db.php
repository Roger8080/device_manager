...
$consulta_manutencao_edition = mysqli_query($conexao,$query);
...
WHERE m.status = '4'";
$consulta_retirada = mysqli_query($conexao,$query);
...
WHERE m.status = '5'";
$consulta_devolucao = mysqli_query($conexao,$query);
...
$consulta_garantia = mysqli_query($conexao,$query);
...
$consulta_tbmobile_chamados = mysqli_query($conexao,$query);
...
LEFT JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile = mysqli_query($conexao,$query);

$query = "SELECT u.ender, m.id, m.unidade, u.sigla, m.IMEI, m.SERIE, m.NUMERO, s.status, m.DATA
FROM tbmobile m
INNER JOIN unidade u ON  u.ender = m.UNIDADE
left JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile0 = mysqli_query($conexao,$query);
...
INNER JOIN unidade u ON  u.ender = m.UNIDADE
LEFT JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile1 = mysqli_query($conexao,$query);
...
INNER JOIN unidade u ON  u.ender = m.UNIDADE
LEFT JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile2 = mysqli_query($conexao,$query);
...
INNER JOIN unidade u ON  u.ender = m.UNIDADE
left JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile22 = mysqli_query($conexao,$query);

$query = "SELECT u.ender, m.id, m.unidade, u.sigla, m.IMEI, m.SERIE, m.NUMERO, s.status, m.DATA FROM tbmobile m
INNER JOIN unidade u ON  u.ender = m.UNIDADE
left JOIN tbstatus s ON m.STATUS = s.id";
$consulta_tbmobile3 = mysqli_query($conexao,$query);
...
$consulta_problema0 = mysqli_query($conexao,$query);

$query = "SELECT id, descricao FROM tb_problema order by descricao asc";
$consulta_problema1 = mysqli_query($conexao,$query);

$query = "SELECT id, descricao FROM tb_problema order by descricao asc";
$consulta_problema2 = mysqli_query($conexao,$query);
$query = "SELECT id, garantia FROM tbstatus where ativo = '1'";
$consulta_alert2 = mysqli_query($conexao,$query);

$query = "SELECT id, descricao FROM tb_problema order by descricao asc";
$consulta_problema3 = mysqli_query($conexao,$query);

$query = "SELECT id, descricao FROM tb_problema order by descricao asc";
$consulta_problema4 = mysqli_query($conexao,$query);

$query = "SELECT id, descricao FROM tb_problema order by descricao asc";
$consulta_problema5 = mysqli_query($conexao,$query);
...
$consulta_osi = mysqli_query($conexao,$query);

$query = "SELECT ordem_servico FROM tbmobile_os ORDER BY id DESC LIMIT 1";
$consulta_osi0 = mysqli_query($conexao,$query);

$query = "SELECT ordem_servico FROM tbmobile_os ORDER BY id DESC LIMIT 1";
$consulta_osi1 = mysqli_query($conexao,$query);

$query = "SELECT ordem_servico FROM tbmobile_os ORDER BY id DESC LIMIT 1";
$consulta_osi2 = mysqli_query($conexao,$query);

$query = "SELECT ordem_servico FROM tbmobile_os ORDER BY id DESC LIMIT 1";
$consulta_osi3 = mysqli_query($conexao,$query);
...
$consulta_sigla = mysqli_query($conexao,$query);


$query = "SELECT ender, sigla FROM unidade";
$consulta_sigla0 = mysqli_query($conexao,$query);

$query = "SELECT id, status FROM tbstatus";
$consulta_status = mysqli_query($conexao,$query);
...
$consulta_manutencao_abertos = mysqli_query($conexao,$query);
...
WHERE dt_encerramento IS NULL";
$consulta_garantia_abertos = mysqli_query($conexao,$query);
...
$consulta_retirada_abertos = mysqli_query($conexao,$query);
...
$consulta_devolucao_abertos = mysqli_query($conexao,$query);
...
WHERE t.status = '5'";
$consulta_mov = mysqli_query($conexao,$query);
